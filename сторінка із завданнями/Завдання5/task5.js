...
if(i===2){
	...
	if(i===3){
		...
		console.log(''+Math.pow(a, 2)+''+character1+'^2-'+2 *a*b+''+character1+'+'+Math.pow(b, 2)+'');
		//console.log(y);
	...
	if(i===4){
		...
		console.log(''+Math.pow(a, 3)+''+character1+'^3-'+3 *Math.pow(a, 2)*b+''+character1+'^2+'+3 * a*Math.pow(b, 2)+''+character1+'-'+Math.pow(b, 3)+'');
	...
	if(i===6){
		container.innerHTML= 'Красава! Молодець<div><a href = "../../підготовка до вступної контрольної роботи/Task6/task_6.html" class = "btn-form1">Рішать далі</a></div>';
	}
