...
if(i===2){
	...
	if(i===4){
		container.innerHTML= 'Красава! Молодець<div><a href = "../../../підготовка до вступної контрольної роботи/Неріності/Task4/task_4.html" class = "btn-form1">Рішать далі</a></div>';
	}
