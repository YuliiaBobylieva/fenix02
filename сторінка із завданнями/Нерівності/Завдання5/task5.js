...
let arc = [1, 2, 4, 5];
	...
	if(i===6){
		container.innerHTML= 'Красава! Молодець<div><a href = "../../../підготовка до вступної контрольної роботи/Нерівності/Task6/task_6.html" class = "btn-form1">Рішать далі</a></div>';
	}
