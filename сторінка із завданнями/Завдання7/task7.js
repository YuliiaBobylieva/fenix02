...
if(i===2){
	...
	if(i===6){
		...
		let character1Arr = ['q', 'w', 'e', 'r', 't', 'y'];
			...
			//console.log(''+a+''+f+'-'+g+''+a+'+'+b+''+f+'-'+g+''+b+'-'+c+''+d+'+'+c+''+e+'');
			//console.log(''+c+''+f+'-'+c*g+'');
	...
	if(i===8){
		container.innerHTML= 'Красава! Молодець<div><a href = "../../підготовка до вступної контрольної роботи/Task8/task_8.html" class = "btn-form1">Рішать далі</a></div>';
	}
